...
insert into plant(id,plant_name,plant_time,plant_desc,plant_price,quantity)
 VALUES
 (1,'Aconite','Early Spring','Aconites are one of the first bulb flowers to bloom in the spring and are known for their cheerful yellow color. Plant Aconites in a large group together and youll be able to smell their sweet, honey-like fragrance.',20,395),
 (2,'Ageratum','Mid‑Summer - Mid‑Fall','Also known as Flossflower, Ageratums come in blue, pink and white blooms. The taller varieties are best for cutting and displaying in your home, while the dwarf bedding varieties are best kept in the garden.',20 ,793),
 (3,'Allium','Late Spring - Mid‑Summer','There are five varieties of the Allium, known primarily for their tall stems and large, spherical heads. Blooms are typically violet, but blue and pink varieties can also be found.',20 ,893),
 (4,'Anemone','Mid Spring - Mid‑Fall','The Anemone includes 120 species of flowers, but the most common types found in North America come in white, pink or violet hues. The Anemone is dainty and doesnt grow well during summer droughts, overly wet winters or high winds.',20 ,337),
 (5,'Angelica','Summer','Commonly found in tea and herbal remedies, the stem of the Angelica can even be made into candy. With over 50 species, the Angelica is also good for bees and other pollinators. Known for their large starburst flowers, it comes in white or green.',20 ,3732),
 (6,'Angelonia','Mid‑Summer - Mid‑Fall','Especially good for container gardening, the Angelonia will keep blooming all summer even if old flowers are removed. Once tall enough to cut, bring them inside and youll notice a light scent that some say is reminiscent of apples.',20 ,283),
 (7,'Artemisia','Late Summer','For those seeking a drought tolerant plant that doesnt make your yard look like a dessert, the Artemisia is for you. Tolerating low amounts of water, you can create a diverse xeriscape with this silvery flower.',20,123),
 (8,'Aster','Late Spring - Early Fall','Named after the Latin word for "star," Asters will brighten up any garden. It attracts butterflies and comes in a variety of colors including blue, indigo, violet, white, red and pink. Unlike other colorful flowers, Asters will typically stay in bloom into cooler fall months.',20,3688),
 (9,'Astilbe','Late Spring - Early Fall','Astilbes are deceptively delicate with their long, fern-like flowers. These flowers can actually withstand damp soil and shade, while still growing between one to six feet tall. Perfect to add for a pop of color to a garden that typically gets little sunlight.',20,525),
 (10,'Aubrieta','Mid-Spring - Early Summer','Named after Claude Aubriet, a French artist who famously painted them, Aubrietas spread low with small violet, pink or white flowers. If youre creating a rock garden, Aubrietas are ideal as it prefers sandy, well-drained soil.',20 ,737),
 (11,'Azalea','Spring','Often referred to as "the royalty of the garden," these elegant flowers are known for their outstanding colors and foliage. With thousands of varieties to choose from, Azaleas require little maintenance once planted and can be brought inside to make a fabulous bouquet.',20 ,238);
